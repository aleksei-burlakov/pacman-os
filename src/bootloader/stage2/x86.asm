...
_x86_Video_WriteCharTeletype:
    ...
    ; note: bytes are converted to words (one can't just push a single byte on the stack)
    mov ah, 0Eh
    mov al, [bp + 4]
    mov bh, [bp + 6]
...
_x86_Disk_Reset:
    ...
    mov ax, 1           ; 1 on success, 0 on fails
    sbb ax, 0           ; subtract zero flag to invert the result (in bios 0 - is success)
