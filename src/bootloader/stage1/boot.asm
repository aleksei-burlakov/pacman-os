...
.after:
    ...
    ; note: this section can be hardcodede
    ...
    inc ax                            ; division remainder != 0, add 1
                                      ; this means we have a secotr only partially filled with entries
.root_dir_after:
    ; read root directory
    mov cl, al                        ; cl = number of sectors to read = size of root directory
    pop ax                            ; ax = LBA of root directory
    mov dl, [erb_drive_number]        ; dl = drive number (we saved it previously)
...
msg_loading:          db 'Loading...', ENDL, 0  ; msg_loading - is a label/pointer to address of array of bytes
